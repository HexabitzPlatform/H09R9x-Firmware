...
void HAL_UART_MspInit(UART_HandleTypeDef *huart){
	...
	if(huart->Instance == USART1){
		...
		hUartDMA[(GetPort(huart)-1)] = &hdma_usart1_rx;
		...
		hUartDMA[(GetPort(huart)-1)] = &hdma_usart2_rx;
		...
		hUartDMA[(GetPort(huart)-1)] = &hdma_usart3_rx;
		...
		hUartDMA[(GetPort(huart)-1)] = &hdma_usart4_rx;
		...
		hUartDMA[(GetPort(huart)-1)] = &hdma_usart5_rx;
		...
		hUartDMA[(GetPort(huart)-1)] = &hdma_usart6_rx;
